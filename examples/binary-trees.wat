(module $binary-trees.wasm
  ...
  (type (;14;) (func (param f64 i64 i64) (result f64)))
  ...
  (func $_start (type 7)
    ...
    unreachable)
  (func $NewTreeNode (type 2) (param i32 i32) (result i32)
    ...
    local.get 11
    return)
  (func $ItemCheck (type 3) (param i32) (result i32)
    ...
    local.get 20
    return)
  (func $BottomUpTree (type 3) (param i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 1
    i32.const 16
    ...
    local.get 20
    return)
  (func $DeleteTree (type 6) (param i32)
  ...
  (func $main (type 2) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 f64 f64 f64 f64 f64 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 2
    i32.const 96
    local.set 3
          ...
          block  ;; label = @4
            block  ;; label = @5
                          ...
                          block  ;; label = @12
                            block  ;; label = @13
                              ...
                              block  ;; label = @14
                                ...
                                i32.const 0
                                i64.const -1
                                i64.store offset=10584 align=4
                                i32.const 0
                                i64.const 281474976776192
                                i64.store offset=10576 align=4
                                i32.const 0
                                local.get 1
                                i32.const 8
                                i32.add
              ...
              block  ;; label = @6
                ...
                i32.add
                i32.const 0
                i64.load offset=10556 align=4
                i64.store align=4
                local.get 9
                i32.const 0
                i64.load offset=10548 align=4
  ...
  (func $__wasm_call_dtors (type 7)
    call $dummy
    call $__stdio_exit)
  (func $__math_invalid (type 9) (param f64) (result f64)
    local.get 0
    local.get 0
    f64.sub
    local.tee 0
  ...
  (func $__math_uflow (type 11) (param i32) (result f64)
    ...
    call $__math_xflow)
  (func $pow (type 12) (param f64 f64) (result f64)
    (local i64 i32 i32 i64 i32 i32 i64 f64 f64 f64 f64 f64 f64 f64 f64 f64)
    local.get 1
    i64.reinterpret_f64
    local.tee 2
    i64.const 52
    ...
    block  ;; label = @1
      ...
      local.get 0
      i32.const 0
      f64.load offset=1384
      f64.mul
      i32.const 0
      f64.load offset=1376
      f64.add
      f64.mul
      local.get 1
      local.get 0
      i32.const 0
      f64.load offset=1368
      f64.mul
      i32.const 0
    ...
    local.get 9)
  (func $checkint (type 13) (param i64) (result i32)
    (local i32 i32 i64)
    i32.const 0
    local.set 1
    block  ;; label = @1
    ...
    local.get 1)
  (func $specialcase (type 14) (param f64 i64 i64) (result f64)
  ...
  (func $long_double_not_supported (type 7)
    ...
    call $abort
    unreachable)
  (func $atol (type 3) (param i32) (result i32)
    (local i32 i32 i32 i32 i32)
    loop  ;; label = @1
      local.get 0
      i32.load8_s
  ...
  (table (;0;) 5 5 funcref)
  (memory (;0;) 2)
  (global $__stack_pointer (mut i32) (i32.const 77232))
